...
interface CandyMachineState {
    ...
    collectionPDA: anchor.web3.PublicKey;
}
...
export const getCandyMachineState = async (
    ...
    const [collectionPDA] = await getCollectionPDA(new anchor.web3.PublicKey(candyMachineId));

    const state: any = await program.account.candyMachine.fetch(candyMachineId);

    const collectionState: any = await program.account.collectionPda.fetch(collectionPDA);
    ...
    return {
        ...
        state: {
            ...
            tokenMint: collectionState.mint,
...
export const getCandyMachineCreator = async (
    ...
    console.log(typeof candyMachine);
...
export const createAccountsForMint = async (
    ...
    console.log(userTokenAccountAddress.toBase58(), mint.publicKey.toBase58(), payer.toBase58());
...
export const mintOneToken = async (
    ...
    const [candyMachineCreator, creatorBump] = await getCandyMachineCreator(
        new anchor.web3.PublicKey(candyMachineAddress)
    );
    ...
    const [collectionPDA] = await getCollectionPDA(new anchor.web3.PublicKey(candyMachineAddress));
